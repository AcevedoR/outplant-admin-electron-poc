...
contextBridge.exposeInMainWorld('electronAPI', {
  openChainFile: (fileAbsolutePath: string) => ipcRenderer.invoke('files:openChainFile', fileAbsolutePath),
  getCurrentChainsDirectory: () => ipcRenderer.invoke('files:getCurrentChainsDirectory'),
  getChainsFilenames: (chainsDirectory: string) => ipcRenderer.invoke('files:getChainsFilenames', chainsDirectory),
});
